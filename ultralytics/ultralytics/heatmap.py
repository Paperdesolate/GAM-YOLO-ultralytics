...
def get_params():
    params = {
        'weight': 'runs/detect/train5/weights/best.pt ',  # 训练出来的权重文件
        'cfg': 'ultralytics/cfg/models/v8/yolov8.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'1/test.jpg', 'result/9ceng')  # 第一个是检测的文件, 第二个是保存的路径