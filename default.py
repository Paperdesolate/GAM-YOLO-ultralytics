...
# Train settings -------------------------------------------------------------------------------------------------------
model: yolov8m-seg.pt  # 'D:/ultralytics/yolov8n.pt# (str, optional) path to model file, i.e. yolov8n.pt, yolov8n.yaml
data:  # 'D:/ultralytics/ultralytics/cfg/datasets/coco8.yaml # (str, optional) path to data file, i.e. coco128.yaml
